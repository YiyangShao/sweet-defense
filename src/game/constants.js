...
export const ENEMY_DEFS = {
  mouse:    { Comp: Mouse,    hp: 22,  speed: 1.4, reward: 8,  name: '糖糖鼠',   damage: 1,           desc: '速度快、生命少',  tag: '基础' },
  rabbit:   { Comp: Rabbit,   hp: 16,  speed: 2.0, reward: 10, name: '跳跳兔',   damage: 1,           desc: '可跳过部分塔',    tag: '特殊' },
  hedgehog: { Comp: Hedgehog, hp: 90,  speed: 0.7, reward: 18, name: '刺刺球',   damage: 2,           desc: '装甲厚血量高',    tag: '装甲' },
  squirrel: { Comp: Squirrel, hp: 30,  speed: 1.3, reward: 12, name: '抢糖松鼠', damage: 1, steal: 6, desc: '会偷走糖果',      tag: '小偷' },
  raccoon:  { Comp: Raccoon,  hp: 38,  speed: 1.2, reward: 14, name: '夜行浣熊', damage: 1,           desc: '隐身潜行',        tag: '隐身' },
  pigeon:   { Comp: Pigeon,   hp: 22,  speed: 1.7, reward: 12, name: '云端鸽',   damage: 1,           desc: '飞行单位',        tag: '飞行' },
  fox:      { Comp: Fox,      hp: 42,  speed: 1.4, reward: 16, name: '狡狐',     damage: 1, dodge: 0.22, desc: '会闪避攻击',   tag: '闪避' },
  bear:     { Comp: Bear,     hp: 360, speed: 0.55,reward: 100,name: '蜜熊王',   damage: 5, boss: true,  desc: '关卡 BOSS',     tag: 'BOSS' },
};
